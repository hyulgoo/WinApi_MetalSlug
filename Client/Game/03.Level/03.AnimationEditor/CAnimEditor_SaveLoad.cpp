#include "pch.h"
#include "Game\03.Level\03.AnimationEditor\CAnimEditor.h"
...
#include "Game\04.Object\UI\EditAnim\EditPlayer\CEditPlayer.h"
...
void CAnimEditor::SaveUpperAnimation() const
{
    OPENFILENAME ofn = {};
    ...
    FILE*         pFile   = nullptr;
    const errno_t iErrNum = _wfopen_s(&pFile, szFilePath, L"wb");
    ...
    const size_t iFrmCount = AllFrm.size();
...
void CAnimEditor::LoadUpperAnimation()
{
    ...
    FILE*         pFile   = nullptr;
    const errno_t iErrNum = _wfopen_s(&pFile, szFilePath, L"rb");
    ...
    const size_t iFrmCount = m_vecPrevUpperFrm.size();        
    for (size_t i = 0; i < iFrmCount; ++i)
...
void CAnimEditor::SaveLowerAnimation() const
{
    OPENFILENAME ofn = {};
...
void CAnimEditor::SaveNormalAnimation() const
{
    OPENFILENAME ofn = {};
